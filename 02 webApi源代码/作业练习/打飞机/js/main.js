...
//    document.getElementsByTagName('imggg')[0].style.left=selfplanX-selfplan.plansizeX/2+"px";
//    document.getElementsByTagName('imggg')[0]..style.top=selfplanY-selfplan.plansizeY/2+"px";
}
/*
暂停事件
 */
