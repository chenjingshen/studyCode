      ...
      <div class="panel-body">
        ...
        <?php  
            ...
            if(isset($_GET['search'])){
                ...
                $sql = "SELECT id, champion_name,champion_icon FROM lol WHERE champion_name like '%$search%' order by id desc ";
            }else{
                // 如果没有值 默认访问所有数据
                // echo 'no search';
                $sql = 'SELECT id, champion_name,champion_icon FROM lol order by id desc';
            }
