...
-- 如果没有就创建
create database if not exists `baixiu`;
-- 使用百秀
use baixiu;
...
(1, 'admin', 'admin@heima.me', '123456', '管理员', '/static/uploads/avatar.jpg', NULL, 'activated'),
(2, 'jack', 'jack@heima.com', '123456', '杰克', '/static/uploads/avatar_1.jpg', NULL, 'activated'),
(3, 'rose', 'rose@heima.com', '123456', '肉丝', '/static/uploads/avatar_2.jpg', NULL, 'activated');
